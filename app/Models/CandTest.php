...
class CandTest extends Model
{
    ...
    protected $fillable = ['id','stdid','inst','paper_id','program_id','course_id','starttime','endtime','cqnid','wqnid','uqnid','status','entry_on','entry_by','examip','continueexam','pa','marksobt','switched','paper_checking','result','endExamReason','answerFile'];
