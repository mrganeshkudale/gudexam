...
class CandQuestion extends Model
{
    ...
    protected $fillable = ['id','stdid','inst','paper_id','program_id','qnid','qtopic','qtype','answered','stdanswer','qnid_sr','entry_on','answer_by','answer_on','cans','marks','ip','obtmarks','obtmarks1','exam_id','questMode'];
